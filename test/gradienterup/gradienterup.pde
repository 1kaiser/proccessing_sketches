...
void setup()
{
  ...
  //img = loadImage("w (12).jpg");
  //size( 7860/3, 4320/3);//size(  //img.width*2, //img.height*2 );
  //image(//img, -width*.35, -height*.25, width*1.70, height*2.60);
  filter(THRESHOLD, 0.091);
  ...
  sentence="SHOULD I CALL IT BETTER\n\n";
