...
color  c1= color(90, 0, 200), //background upper gradient 
c2= color(50, 0, 200), //background lower gradient 
...
void setup()
{
  ...
  textFont(font, dist(0, 0, width, height)/10);
  ...
  textFont(font, dist(0, 0, width, height)/13/3);
  textAlign(LEFT, CENTER);
  sentence="PEOPLE\nWERE\nASKED";
  text(sentence, width/2+dist(0, 0, width, height)/13, height/2);
  fill(255, 215, 0);
  textAlign(CENTER, TOP);
  sentence="#NOONEKNOWS";
  textFont(font, dist(0, 0, width, height)/13/4);
  text(sentence, width/2, height/2+dist(0, 0, width, height)/13);
