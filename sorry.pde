  ...
  {
    {
      ...
      for (j=img.height/2-3*n; j >0; j-=3*n) {
        for (i=img.width/2+3*n; i <img.width; i+=3*n) {
          quadrant_compoents();
        }
      }
    }

    {
      ...
      for (j=img.height/2; j >0; j-=3*n) {
        for (i=img.width/2; i >0; i-=3*n) {
          if (j==img.height/2&&i==img.width/2)
          {
            i-=3*n;
          }
          quadrant_compoents();
...

    {
      ...
      for (j=img.height/2+3*n; j <img.height; j+=3*n) {
        for (i=img.width/2-3*n; i >0; i-=3*n) {
          quadrant_compoents();
        }
      }
    }

    {
      ...
      for (j=img.height/2; j <img.height; j+=3*n) {
        for (i=img.width/2; i <img.width; i+=3*n) {
          quadrant_compoents();
        }
      }
    }
